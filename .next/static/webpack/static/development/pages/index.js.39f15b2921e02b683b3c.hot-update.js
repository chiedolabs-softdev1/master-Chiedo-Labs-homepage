...
var Section = function Section() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_2___default()('mr-3', _style_scss__WEBPACK_IMPORTED_MODULE_3___default.a.color),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    },
    ...
    __self: this
  }, "Web appspancations"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
    className: _style_scss__WEBPACK_IMPORTED_MODULE_3___default.a.color,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
...
//       <ul className={css.k}>
//         <span className={css.color}>Build and maintain:</span>
//         <span className={css.color}>Web appspancations</span>
//         <span className={css.color}>Web back-ends</span>
//         <span className={css.color}>Web front-ends</span>
//         <span className={css.color}>Custom websites</span>
//       </ul>
// </div>
...
//# sourceMappingURL=index.js.39f15b2921e02b683b3c.hot-update.js.map